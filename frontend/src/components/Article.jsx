...
function Article({ id, image, nom, vendeuse, prix }) {
  ...
  // </svg>`;
  // const coeurPlein = `<svg width="28.48" height="23.98" viewBox="0 0 33 29" fill="none" xmlns="http://www.w3.org/2000/svg">
  // <path d="M15.6001 26.7436L16.2387 27.277L16.8793 26.746L18.9443 25.0344L18.9465 25.0325L19.0554 24.9418C22.6539 21.9416 25.7252 19.3809 27.8912 16.9496C30.0871 14.4848 31.4824 12.0134 31.4824 9.18631C31.4824 4.53036 27.5055 1 22.6497 1C20.2611 1 17.951 1.88254 16.2412 3.34699C14.5314 1.88254 12.2213 1 9.83265 1C4.9769 1 1 4.53036 1 9.18631C1 12.0134 2.39527 14.4849 4.59133 16.9482C6.76488 19.3863 9.84963 21.9527 13.4641 24.9598L13.5352 25.0189L13.5366 25.0202L15.6001 26.7436Z" fill="#8D214C" stroke="#BDC9AC" stroke-width="2"/>
  // </svg>`;
  // const panier = `<svg width="30.59" height="31.79" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
  // <path d="M4.17797 13.0743C3.99307 11.723 5.04332 10.5193 6.4072 10.5193H25.9543C27.3047 10.5193 28.3509 11.7005 28.1878 13.041L26.889 23.72C26.7516 24.8492 25.793 25.6983 24.6554 25.6983H7.86845C6.74368 25.6983 5.7917 24.8677 5.63922 23.7534L4.17797 13.0743Z" stroke="#442332" stroke-width="1.5"/>
  // <path d="M12.3659 20.9818L12.3817 21.0086L12.3941 21.0371L13.5388 23.6766C14.6805 26.3092 18.4403 26.2316 19.4725 23.5542C20.1223 21.8686 20.8929 20.232 21.7782 18.6573L26.8267 9.67737C28.5131 6.67766 26.3453 2.97209 22.9041 2.97209H9.61658C6.13313 2.97209 3.9706 6.75985 5.74139 9.75964L12.3659 20.9818Z" stroke="#442332"/>
  // <path d="M16.6824 10.8117L15.9535 12.3728C13.9122 16.7452 10.7484 20.8276 6.66088 24.3634V24.3634" stroke="#442332" stroke-width="2" stroke-linecap="round"/>
  // <path d="M16.1548 10.8117L16.8224 12.1145C19.0737 16.5082 22.2352 20.6482 26.1764 24.3634V24.3634" stroke="#442332" stroke-width="2" stroke-linecap="round"/>
  // <rect x="10.753" y="0.787207" width="10.8039" height="4.4122" rx="0.6" stroke="#442332" stroke-width="0.8"/>
  // <path d="M5.07861 17.3716V17.3716C7.75946 16.5153 9.96675 14.5832 11.1412 12.0525L11.717 10.8116M11.717 10.8116L11.1467 12.0405C9.96877 14.5789 7.76756 16.5127 5.07861 17.3716" stroke="#442332" stroke-linecap="round"/>
  ...
  return (
    <div className={`article-container ${vendeuse}`}>
      ...
      <div className="article-ligne-container">
